...
current_data_time = str(datetime.datetime.now())

@APP.route('/Password')
def home():
    return render_template('Password.html', time_passed_in=current_data_time)
...
def check_logs(ip_addr):
    ...
    try:
        ...
        with open(PATH, "w") as out_file:
            dump(data, out_file, indent=4, sort_keys=True)
    except (KeyError, IOError):
        pass
